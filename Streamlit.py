...
url1 = "https://raw.githubusercontent.com/ilpovirt/streamlit_map/main/GPSdata.csv"
url2 = "https://raw.githubusercontent.com/ilpovirt/streamlit_map/main/GPSdata.csv"
location_data = pd.read_csv(url1)
df_step = pd.read_csv(url2)

st.title('Fysiikan loppytyö')
